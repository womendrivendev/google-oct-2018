...
I've included some mocked data using [json-server](https://github.com/typicode/json-server). To use this data while developing locally run the following commands:
